...
const isContentEmpty = (value: JSONContent): boolean => { // Verifica si el contenido de Tiptap está vacío
    ...
    // Recorre los nodos del contenido para verificar si hay al menos un párrafo con texto:
...
export const productSchema = z.object({
    ...
    slug: z
        ...
        .regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, 'Slug inválido'), // expresion regular para validar el slug con minusculas, numeros y guiones
    features: z.array(
        z.object({
            value: z
                .string()
...
// Tipo inferido del formulario de producto:
