...
export const RegisterPage = () => {
    ...
    // Configuración del formulario utilizando react-hook-form y zodResolver:
    const { register, handleSubmit, formState: { errors }, } = useForm<UserRegisterFormValues>({
        ...
        resolver: zodResolver(userRegisterSchema), // Integración de Zod para validar usando la dependencia de resolver
    });
    ...
    const onRegister = handleSubmit(data => {
        ...
        // Llamar a la mutación de registro con los datos del formulario:
        mutate({ email, password, fullName, phone });
    });

    if (isLoading) return <Loader />;

    // Si el usuario ya tiene una sesión activa, redirigir a la página principal:
