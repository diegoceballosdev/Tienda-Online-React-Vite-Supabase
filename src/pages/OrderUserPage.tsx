...
export const OrderUserPage = () => {
	...
	const { data: order, isLoading } = useOrder(Number(id!)); //id! significa que id no es undefined
	...
	return (
		<div>
			<div className='flex flex-col justify-between items-center gap-5 md:flex-row md:gap-0'>
				<button
					className='border rounded-full py-2 border-slate-200 px-5 flex items-center justify-center gap-2 text-xs font-medium uppercase tracking-widest hover:bg-stone-200 transition-all'
					onClick={() => navigate(-1)}
				>
