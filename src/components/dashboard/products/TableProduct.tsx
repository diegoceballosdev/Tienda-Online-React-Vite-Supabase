                                        ...
                                        {openMenuIndex === index && (
                                            ...
                                            >
                                                <Link
                                                    ...
                                                    className='flex items-center gap-1 w-full text-left px-4 py-2 text-xs font-medium text-gray-700 hover:bg-gray-100 hover:text-blue-600'
                                                >
                                                    Editar
                                                ...
                                                <button
                                                    className='block w-full text-left px-4 py-2 text-xs font-medium text-gray-700 hover:bg-gray-100 hover:text-red-600'
                                                    onClick={() =>
