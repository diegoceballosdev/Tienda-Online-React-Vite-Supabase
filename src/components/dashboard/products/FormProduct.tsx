...
export const FormProduct = ({ titleForm }: Props) => {
	...
	const { product, isLoading } = useProduct(slug || '') // usado para editar producto y cargar datos existentes
	...
	const onSubmit = handleSubmit(data => {
		...
		if (slug) { // si hay slug, estamos editando un producto existente
			updateProduct({
				name: data.name,
				brand: data.brand,
				slug: data.slug,
		...
		} else { // si no hay slug, estamos creando un nuevo producto
			createProduct({
				name: data.name,
				brand: data.brand,
				slug: data.slug,
